...
#         ],
    ...
    TARGET_metadata_clinical = {
        ...
        'columns': [
            ...
            ['first_event', 'VARCHAR(24)', 'NULL'],
            ['days_to_birth', 'INT', 'NULL'],
            ['days_to_death', 'INT', 'NULL'],
            ['age_at_diagnosis', 'INT', 'NULL'],
            ['year_of_diagnosis', 'date', 'NULL'],
            ['year_of_last_follow_up', 'date', 'NULL'],
...
#         ]
    ...
    TARGET_metadata_data = {
        'table_name': 'TARGET_metadata_data',
...
#         ]
    ...
    metadata_tables = OrderedDict(
        [
            ...
            ('TARGET_metadata_data', TARGET_metadata_data)
        ]
    )
